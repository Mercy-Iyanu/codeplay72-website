...
export default function CardPlaygroundHome() {
    return <>
        <section className='text-slate-700 p-9 md:w-80'>
            ...
            <div className="card-body mt-6">
                <p className="text-base">This playground is design specially for homeschooling. For parents who love to create a small community for creative children. </p>
            </div>
        </section>
    </>
}